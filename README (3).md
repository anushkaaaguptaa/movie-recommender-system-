...
https://github.com/user-attachments/assets/76813bcd-10d1-4c7c-bc53-9287ee438f32
...
- GitHub: [@DevanshiGoyal](https://github.com/DevanshiGoyal)

## 🙏 Acknowledgments

- [The Movie Database (TMDb)](https://www.themoviedb.org/) for providing the API
- [Streamlit](https://streamlit.io/) for the amazing framework
- [Kaggle](https://www.kaggle.com/) for the TMDb 5000 Movies Dataset
